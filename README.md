...
Windows에서 빌드하고 실행할 수 있는 첫 이동 프로토타입을 만들었습니다. 이동 규칙을 임시 사각형으로 먼저 검증한 뒤, 첫 아바타 후보인 proto_one의 Idle 스프라이트를 붙였습니다. 나머지 동작은 아직 스프라이트가 없습니다. 지형은 계속 임시 사각형이며, 어느 것도 게임의 최종 사양이 아닙니다.
...
- 4프레임으로 반복되는 proto_one의 Idle 애니메이션
